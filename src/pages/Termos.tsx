...
export default function Termos() {
    return (
        <LegalPage title="Termos de Uso">
            <p>
                Ao acessar ao site ArenaCopa, concorda em cumprir estes termos de serviço, todas
            ...
            <p>
                O ArenaCopa é uma plataforma social para criação e gerenciamento de bolões
            ...
            <p>
                <strong>O ArenaCopa não intermedia, incentiva ou gerencia apostas em dinheiro reais.</strong>
                ...
                dos organizadores e envolvidos, isentando o ArenaCopa de qualquer
