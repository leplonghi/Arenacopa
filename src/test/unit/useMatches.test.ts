...
describe("useMatches", () => {
  ...
  it("retorna array vazio quando o Firestore retorna vazio", async () => {
  ...
  it("não lida com erro de fallback, React Query retorna fallback do erro", async () => {
    ...
    // O hook não lida com erro explicitamente — React Query lida com o estado da promise
