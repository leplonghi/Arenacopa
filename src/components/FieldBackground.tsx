// FieldBackground — renders a pure CSS/SVG football pitch atmosphere.
// IMPORTANT: zero external network requests — all effects use only CSS.
const FieldBackground = () => (
  ...
  >
    ...
    {/* Pitch image — local asset only, no CDN */}
    <div
    ...
    {/* Pitch arc lines — pure CSS, no external fetch */}
    ...
    {/* Colour bloom glows — GPU-composited, no network cost */}
