        ...
        <Tooltip delayDuration={200}>
            <TooltipTrigger asChild>
                <button
                    ...
                    aria-label={`Entender desafio ${title}`}
                >
            ...
            <TooltipContent
                ...
                align="start"
                sideOffset={8}
                className="max-w-[260px] rounded-2xl border-white/10 bg-zinc-950 px-4 py-3 text-left text-xs leading-relaxed text-zinc-200"
            >
